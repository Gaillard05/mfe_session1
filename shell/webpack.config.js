...
const getRemoteEntryUrl = (appName) => {
  if (process.env.NODE_ENV === 'production') {
    ...
    const urls = {
      ...
      catalogue: 'https://efrei-catalogue-g1.vercel.app',
      breadcrumb: 'https://efrei-breadcrumb-g1.vercel.app',
      ficheProduit: 'https://efrei-fiche-produit-g1.vercel.app',
      searchbar: 'https://efrei-searchbar-g1.vercel.app'
    };
